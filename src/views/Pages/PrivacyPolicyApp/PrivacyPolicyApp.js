        ...
        <Container fluid>
          <Row>
            <Col>
              ...
              <p>
                <span>
                  Christian Bäuerlein<br />
                  Hessenring 5<br />
                  64832 Babenhausen<br />
                  Germany<br />
                  <br />
                  Email: hello@cndy.store
                </span>
              </p>
              ...
              <p>
                ...
                wir die betroffenen Personen zusammenfassend auch als „Nutzer“).<br />
              </p>
              ...
              <p />
              <h3 id="dsg-monitoring-bugsnag">Bugsnag - Error-Tracking</h3>
              <p />
              <p>
                Mit Hilfe des Error-Trackings stellen wir die Verfügbarkeit und
                Integrität unseres App/Onlineangebotes sicher und verwenden die
                dabei verarbeiteten Daten, um unser App/Onlineangebot technisch
                zu optimieren.
              </p>
              <br />
              <p>
                Zu diesen Zwecken setzen wir den Dienst Bugsnag, Inc, 939
                Harrison St, San Francisco, CA 94107, United States, ein.
                Bugsnag ist unter dem Privacy-Shield-Abkommen zertifiziert und
                bietet hierdurch eine Garantie, das europäische Datenschutzrecht
                einzuhalten (<a
                  target="_blank"
                  href="https://www.privacyshield.gov/participant?id=a2zt0000000TNPiAAO&amp;status=Active"
                >
              ...
              <br />
              <p>
                Im Fall von Fehlern und Auffälligkeit, werden einzelne Anfragen
                der Nutzer unseres App/Onlineangebotes pseudonym erfasst, um
                Problemquellen zu identifizieren und zu beheben. Pseudonym
                bedeutet in dem Fall insbesondere, dass die IP-Adressen der
                Nutzer (in anonymer Form) gespeichert werden, sowie Einzelheiten
                zu der Operation und dem Gerät, bei dem der Fehler aufgetreten
                ist.
              </p>
              <br />
              <p>
                Wir setzen Bugsnag auf Grundlage unserer berechtigten Interessen
                an der Sicherheit, Fehlerfreiheit und Optimierung unseres
                App/Onlineangebotes gem. Art. 6 Abs. 1 lit. f DSGVO ein.
              </p>
              <br />
              <p>
                Weitere Informationen zur Verarbeitung personenbezogener Daten
                durch Bugsnag, erhalten Sie in der Datenschutzerklärung des
                Dienstes: <u>https://docs.bugsnag.com/legal/privacy-policy/</u>.
              </p>
